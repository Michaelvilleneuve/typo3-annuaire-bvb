...
/**
 * Test case for class BVB\AnnuaireBvb\Controller\OrganismeController.
 *
...
class OrganismeControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \BVB\AnnuaireBvb\Controller\OrganismeController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('BVB\\AnnuaireBvb\\Controller\\OrganismeController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllOrganismesFromRepositoryAndAssignsThemToView()
	{
		...
		$organismeRepository = $this->getMock('BVB\\AnnuaireBvb\\Domain\\Repository\\OrganismeRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$organisme = new \BVB\AnnuaireBvb\Domain\Model\Organisme();
